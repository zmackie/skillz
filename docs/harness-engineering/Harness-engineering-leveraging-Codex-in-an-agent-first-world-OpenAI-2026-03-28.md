...
**Source:** https://openai.com/index/harness-engineering/#manage-cookies
**Saved:** 2026-03-28T19:36:48.965Z
...
-   [We started with an empty git repository](#we-started-with-an-empty-git-repository)
-   [Redefining the role of the engineer](#redefining-the-role-of-the-engineer)
-   [Increasing application legibility](#increasing-application-legibility)
-   [We made repository knowledge the system of record](#we-made-repository-knowledge-the-system-of-record)
-   [Agent legibility is the goal](#agent-legibility-is-the-goal)
-   [Enforcing architecture and taste](#enforcing-architecture-and-taste)
-   [Throughput changes the merge philosophy](#throughput-changes-the-merge-philosophy)
-   [What “agent-generated” actually means](#what-agent-generated-actually-means)
-   [Increasing levels of autonomy](#increasing-levels-of-autonomy)
-   [Entropy and garbage collection](#entropy-and-garbage-collection)
-   [What we’re still learning](#what-were-still-learning)